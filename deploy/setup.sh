...
PROJECT_GIT_URL='https://github.com/amitarvindpatil/DemoAwsDeployement.git'

PROJECT_BASE_PATH='/usr/local/apps/demoproject'
...
$PROJECT_BASE_PATH/env/bin/pip3 install -r $PROJECT_BASE_PATH/DemoProject/requirements.txt
